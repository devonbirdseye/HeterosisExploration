...
1. Pt/Mt genes (proteomics database)
2. Pt/Mt encoded ribosomal proteins (EnsemblPlants Annotation)
3. Nuclear encoded plastid ribosomal proteins (GO GAMER)
4. Nuclear encoded  Mitochondrial ribosome (GO GAMER)
5. Eukaryotic ribosomal proteins (GO GAMER)
6. PhANGs  (cornCyc + kegg)
7. Oxidative Phosphorylation (cornCyc)
8. Glycolysis (cornCyc)
9. Calvin Cycle (cornCyc)
10. Ethylene biosynthesis (cornCyc)
```{r}
df.SL[(grep("chromosome:B73_RefGen_v4:Mt:", df.SL$Protein)),"Gene"]
```
```{r}
